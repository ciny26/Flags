...
export default {
    ...
    computed:{
        headBackgroundColor() {
      return this.$store.getters.getDarkModeStatus ? 'hsl(209, 23%, 22%)' : 'white';
    },
    textColor() {
      return this.$store.getters.getDarkModeStatus ? 'white' : 'hsl(200, 15%, 8%)';
    },
    }
}
</script>
